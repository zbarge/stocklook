...
from stocklook.config import config, BITMEX_KEY, BITMEX_SECRET
import logging
...
API_KEY = config[BITMEX_KEY] or ""
API_SECRET = config[BITMEX_SECRET] or ""
...
WATCHED_FILES = [join(base_dir, 'market_maker.py'),
                 join(base_dir, 'api.py'),
                 join(base_dir, 'settings.py')]
